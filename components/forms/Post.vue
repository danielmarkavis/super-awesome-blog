<template>
  <div class="max-w-xl mx-auto">
    <template v-if="(record && editing) || !editing">
      <div
        class="text-primary dark:bg-level-1 shadow-md rounded px-8 pt-6 pb-8 mb-4"
      >
        <div class="mb-4">
    ...
    <template v-else>
      <div class="text-center p-5">No article found!</div>
    </template>
...
const { fetchArticle, createArticle, updateArticle, deleteArticle } =
  ArticleRepository();
